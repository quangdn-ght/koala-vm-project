...
################################################################################
# Kong (FShare) VM Automatic Backup Script
# Creates daily backups of kong-gateway disk and libvirt XML
################################################################################
...
# Log file
LOG_FILE="${BACKUP_DIR}/backup-kong-gateway.log"
...
log_info "=========================================="
log_info "Kong (kong-gateway) VM Backup Starting"
log_info "=========================================="
